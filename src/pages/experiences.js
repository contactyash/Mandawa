...
const Experiences = props => {
  return (
    <Layout invert fullWidth>
      <ExtendStyles>
        ...
        <div className="imageDiv">
          <h1>Experiences</h1>
          <h2>Camel Safari </h2>
          <p>The camel is an amazing creature. Gentle yet occasionally cussed, the camel is the ultimate desert SUV. Lawrence of Arabia led the charge on Aqaba astride one and the nomads of Rajasthan still use them regularly to travel vast distances. Getting on to one while it's seated is quite easy, but then as it lurches to its feet in three stages the experience can be quite unnerving the first time. But once you're on and perched six feet above the ground, your perspective changes and riding into the sunset you can fantasize about global conquests or Arabian nights!</p>
          <p>Mandawa is one of the most popular circuits for Camel Safari. The gateway to the Shekhawati region of Rajasthan, where every home bears exquisitely painted wall murals. Admire the beautiful murals in the magnificent havelis (large stately homes) lining the streets of Mandawa.
</p>
          <h2>
            Cultural Activities
</h2>
          ...
          <p><b>Gowari Dance </b>- The most famous art form of the Bhil tribe is the “Gowari” which is a kind of dance drama. The troupe travels from village to village to perform their dance drama. In between the drama enactments, the entire troupe dances around a central spot which is considered holy.</p>
          <p>
            <b> Ghoomar Dance </b>- The Ghoomar dance is a very famous community dance of women in Rajasthan. It is performed on various auspicious occasions like fairs & festivals, weddings and other family functions. The performers in Ghoomar dance sway in circles to a repetitive rhythm.
    Terahtali Dance - The Terahtali dance is a very fascinating and unusual dance of Rajasthan. It is considered as a devotional form of dance and it is performed by women folk in a sitting posture. It is termed as `Terahtali" as terah (thirteen) manjeeras or cymbals are used to create rhythm on which, the dancers move. Manjeeras are tied on their wrists, elbows, waists, arms and a pair in their hands as well.  Sometimes, they may hold a sword between their teeth or do the balancing act of holding of pots or lighted lamps on their heads. The Kamad community of Rajasthan is privileged to perform it.
          ...
          <p>Our tour aims at giving boost to Village Tourism in India. Experience an amazing village life at its most pure with all the required comforts by spending few days in the Indian village, talk to the villages and peep into their daily life to have a better understanding of their livelihood, culture and customs.

</p>
          <p>At Mandawa Heritage Tour, we specialize in arranging Village Tour  and cover all the major segments. Our professional and friendly tour guide will take you to the rural villages of Shekhawati as per your choice and help you in interacting with villagers, enjoying the meals prepared by the locals, visiting their abodes and explore their culture values. So, allow us to plan your next village tour as per your needs and preferences.
</p>
          <h2>Yoga and Meditation</h2>
          <p>
            Yoga and meditation are Hinduism's unique gift to the world. They strengthen your body and mind providing mental peace and physical power, help you fight disease and live longer, stronger and healthier.
        </p>
          <p>When in India, the birthplace of Yoga and Meditation, one must take up at least one session of both - Highly Recommended. While Yoga works on your physical and mental state of well being, Meditation works on the spiritual level helping you connect with your inner self. Both the practices together assist you in cleansing and decluttering your mind and body of any physical or emotional toxins.</p>
          <p>Let us connect you to one of the accomplished gurus who can guide you in achieving inner peace and tranquility. All you need for a yoga session is an hour at hand and the will to pursue.
</p>
          <h2>Cookery classes</h2>
          <p>These classes are targeted at typical Indian home-style cooking where you can choose to participate in the cooking or merely watch and learn. You get a chance to visit local market and buy your choice of food and prepare it yourself under the guidance of an expert chef. One of the most enriching activities, cooking classes have become very popular among tourists. You not only take back wonderful memories, experience and pictures of the classes but also learn the recipes and cooking methods of the exotic Rajasthani delicacies. Your day will be totally engaged in :</p>
          <ul>
            <li>A theoretical introduction to the various dishes.</li>
            <li>Menu planning</li>
            <li>Procurement of raw material - visit to the market</li>
            <li>Preparing to cook - wash, clean, chop, knead</li>
            <li>Introduction to the Indian spices</li>
            <li>Preparing the meal of your choice</li>
            <li>Relishing what you prepared</li>
            <li>Relishing what you prepared</li>
            <li>Masala Tea after a little rest</li>
          </ul>
          <h2>Mehendi/ Heena Art</h2>
          <p>Mehndi is a form of body art from Ancient India, in which decorative designs are created on a person's body, using a paste, made from the powdered dry leaves of the henna plant (Lawsonia inermis). Ancient in origin, mehndi is still a popular form of body art among the women of the Indian Subcontinent, Africa and the Middle East. Among the various forms of mehndi art practiced all over India, the Rajasthani Mehndi in particular is considered to be most superior due to its rich colours and intricate designs. Mehndi application is considered a symbol of good luck for all auspicious occasions across all religions in India. The brides and grooms also apply Mehndi before their wedding, in fact a whole pre-wedding evening is dedicated to the ceremony of mehndi. Mehndi is said to have medicinal properties and works as an antiseptic and is used in therapies to treat anxiety disorders too.</p>
          <p>These days Mehndi is used in making temporary tattoos which fade away gradually over a week - ten days. Indulge in this creative art with one of our master artists and create your own patterns and designs. A fun filled activity with some light snacks and beverages is a sure way to enhance your holiday experience.
</p>
        </div>
